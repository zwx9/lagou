...
<%@taglib prefix="zwxTag" uri="http://www.zwx.com" %>
    ...
    <script type="text/javascript" >
        $(document).ready(function(){
            $("#cancelLogin").click(function(){
                $.ajax({
                    type:'post',
                    url:'http://localhost:8080/userServlet/cancel',
    ...
    <div id="header">
        <div class="wrapper">
            ...
            <ul class="loginTop">
                ...
                <zwxTag:zwxlogoff>
                    <li><a href="list.jsp" rel="nofollow">${sessionScope.user}</a></li>
                    <li>|</li>
                    <li><a href="javascript:void(0)" id="cancelLogin" rel="nofollow">退出</a></li>
                </zwxTag:zwxlogoff>
            </ul>
