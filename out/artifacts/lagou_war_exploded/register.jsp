	...
	<div class="login_wrapper" >
		...
		<div class="login_box">
        	<form id="user_regBindForm">
            	...
            	<input  type="text" id="user_LoginEmail" name="email" tabindex="1" placeholder="请输入常用邮箱地址" />
                <span class="error" style="display:none;" id="beError"></span>
                <input type="password" id="user_LoginPassword" name="password" tabindex="2" placeholder="请输入密码" />
                ...
                <input type="submit" id="user_NoAccount" value="注 &nbsp; &nbsp; 册" />
	    	 ...
	    	 $("#user_regBindForm").validate({
			    	...
			    	submitHandler:function(form){
			            ...
			            $.ajax({
			            	...
			            	url:'http://localhost:8080/userServlet/register',
			            	dataType:'text'
