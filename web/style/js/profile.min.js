            ...
            $(this).validate({
                ...
                submitHandler: function (a) {
                    ...
                    $(a).find(":submit").val("保存中...").attr("disabled", !0),
                        $.ajax({
                        url: "http://localhost:8080/jianliServlet/jianli_proExp",
                        type: "POST",
                        data: {
                            projectName: b,
                            positionName: c,
                        ...
                        dataType: "json"
                            ...
                            $("#resubmitToken").val(b.resubmitToken),
                                b.success ? (c = b.content,
                                                e = "",
                                                3 == b.code ? "" != c ?
                                            (e += '<li data-id="' + c.email + '">',
                                                e += '<div class="projectList"><i class="sm_del dn"></i><i class="sm_edit dn"></i><div class="f16 mb10" data-proName="'
                                                    + c.projectName + '" data-posName="'
                                                    + c.positionName + '" data-startY="'
                                                    + c.startYear + '" data-startM="'
                                                    + c.startMonth + '" data-endY="'
                                                    + c.endYear + '"' + 'data-endM="'
                                                    + c.endMonth + '">'
                                                    + c.projectNameAndRemark + '<span class="c9">（'
                                                    + c.startDate + "-"
                                                    + c.endDate + "）</span></div>",
                                            "" != c.projectRemark && (e += '<div class="dl1">' + c.projectRemark + "</div>"),
                                                e += "</div></li>", "" != $.trim(d.obj.children(".projectShow").children(".plist").html()) && $(a).remove(),
                                            ...
                                            + c.endYear + '"' + 'data-endM="'
                                            + c.endMonth + '">'
                                            + c.projectNameAndRemark + '<span class="c9">（' + c.startDate + "-" + c.endDate + "）</span></div>",
                                            "" != c.projectRemark && (e += '<div class="dl1">' + c.projectRemark + "</div>"),
                                            e += "</div>",
                                            ...
                                            $("#resumeScore .which span").attr("rel", b.content.infoCompleteStatus.nextStage), scoreChange(b.content.infoCompleteStatus.score), k(d.obj), b.content.isNew && changeAllIds(b.content.jsonIds)) : alert(b.msg),
    ...
    window.onbeforeunload = function () {
        ...
        submitHandler: function (a) {
            ...
            $(a).find(":submit").attr("disabled", !0),
                $.ajax({
                url: "http://localhost:8080/jianliServlet/jianli_rename",
                type: "POST",
                data: {jlname: b,
                    email: c},
                dataType: "json"
                ...
                if (b.success) {
                    var c = "";
                    c = b.content.jlname.length > 18 ? b.content.jlname.substring(0, 15) + "..." : b.content.jlname,
                        $("#resume_name .nameShow h1").attr("title", b.content.jlname).text(c).parent().removeClass("dn"),
        ...
        submitHandler: function (a) {
            ...
            $(a).find(":submit").val("保存中...").attr("disabled", !0),
                $.ajax({
                url: 'http://localhost:8080/jianliServlet/jianli_basic',
                type: "POST",
                data: {
                    name: b,
                    gender: c,
                ...
                var c, d, e;
                    b.success ?
                        "/resume/myresume.html" == b.content ?
                            window.location.href = ctx + b.content.url :
                            (c = b.content, d = c.workyear, "应届毕业生" != d
                                ? (d += "工作经验", $("#workExperience h2 span").text("（投递简历时必填）"))
                                : $("#workExperience h2 span").text(""),
                        e = c.name,
                        "" != c.gender && (e += " | " + c.gender), "" != c.topDegree && (e += " | " + c.topDegree),
                        e += " | " + d + "<br />" + c.tel + " | " + c.email + "<br />" + c.currentState,
                        ...
                        $("#nameVal").val(c.name),
                        $("#genderVal").val(c.gender),
                        $("#topDegreeVal").val(c.topDegree),
                        $("#workyearVal").val(c.workyear),
                        $("#currentStateVal").val(c.currentState),
        ...
        errorPlacement: function (a, b) {
            "hidden" == b.attr("type")
                ? a.appendTo($(b).parent())
                : "radio" == b.attr("type") ? a.insertAfter($(b).parents("ul")) : a.insertAfter(b)
        },
        submitHandler: function (a) {
            var c = $('input[name="expectCity"]', a).val(),
                d = $('input[name="type"]:checked', a).val(),
                e = "期望职位，如：产品经理" != $('input[name="expectPosition"]', a).val() ?
            ...
            $(a).find(":submit").val("保存中...").attr("disabled", !0),
                $.ajax({
                url: "http://localhost:8080/jianliServlet/jianli_expect",
                type: "POST",
                data: {
                    city: c,
                    positionType: d,
        ...
        $(this).validate({
            ...
            errorPlacement: function (a, b) {
                ...
                "companyMonthEnd" == b.attr("name") ? a.appendTo($(b).parent().parent()) : a.insertAfter(b)
            },
            submitHandler: function (a) {
                ...
                $(a).find(":submit").val("保存中...").attr("disabled", !0),
                    $.ajax({
                    url: "http://localhost:8080/jianliServlet/jianli_workExp",
                    type: "POST",
                    data: {
                        companyName: b,
                        positionName: d,
                    ...
                    if ($("#resubmitToken").val(b.resubmitToken), b.success) {
                        ...
                        d = b.content,
                            ...
                            alert("添加成功2"),
                            e += 0 == f % 2
                                ? '<li data-id="' + d.id + '" class="clear">'
                                : '<li data-id="' + d.id + '">',
                                e += '<i class="sm_del dn"></i><i class="sm_edit dn"></i><span class="c9" data-startYear="'
                                    + d.startYear + '" data-endYear="'
                                    + d.endYear + '" data-startMonth = "'
                                    + d.startMonth + '" data-endMonth = "'
                                    + d.endMonth + '">'
                                    + d.startDate + "-"
                                    + d.endDate + "</span>" + "<div>" + '<img src="' + ctx + "/"
                                    + d.companyLogo + '" width="56" height="56" alt="'
                                    + d.companyName + '" />' + "<h3>"
                                    + d.positionName + "</h3>" + "<h4>"
                                    + d.companyName + "</h4>" + "</div>" + "</li>";
        ...
        $(this).validate({
            ...
            submitHandler: function (a) {
                ...
                $(a).find(":submit").val("保存中...").attr("disabled", !0),
                    $.ajax({
                    url: 'http://localhost:8080/jianliServlet/jianli_eduShow',
                    type: "POST",
                    data: {
                        schoolName: b,
                        education: c,
                    ...
                    if ($("#resubmitToken").val(b.resubmitToken), b.success) {
                        ...
                        for (c = b.content, d = "", e = 0; e < c.length; e++)
                            d += 0 == e % 2
        ...
        rules: {selfDescription: {required: !1}},
            ...
            $(a).find(":submit").val("保存中...").attr("disabled", !0),
                $.ajax({
                url:  "http://localhost:8080/jianliServlet/jianli_desc",
                type: "POST",
                data: {myRemark: b,
                        email: c,
                        resubmitToken: d},
                ...
                $("#resubmitToken").val(b.resubmitToken),
                    b.success ? (c = b.content, d = "",
                            ...
                            $("#lastChangedTime span").text(b.content.refreshTime),
                            $("#resumeScore .which div").text(b.content.infoCompleteStatus.msg),
                            $("#resumeScore .which span").attr("rel", b.content.infoCompleteStatus.nextStage), scoreChange(b.content.infoCompleteStatus.score), k(g.obj)) : (g.text = "", g.obj.children(".c_edit").addClass("dn"), g.obj.children(".descriptionShow").addClass("dn"), g.obj.children(".descriptionEdit").addClass("dn"), g.obj.children(".descriptionAdd").removeClass("dn"), $("#lastChangedTime span").text(b.content.refreshTime),
                            $("#resumeScore .which div").text(b.content.infoCompleteStatus.msg),
                            $("#resumeScore .which span").attr("rel", b.content.infoCompleteStatus.nextStage), scoreChange(b.content.infoCompleteStatus.score), k(g.obj)), b.content.isNew && changeAllIds(b.content.jsonIds)) : alert(b.msg),
                            $(a).find(":submit").val("保 存").attr("disabled", !1)
            })
        }
    }), h = {
